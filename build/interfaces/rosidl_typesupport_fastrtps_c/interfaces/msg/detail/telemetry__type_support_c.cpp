...
#include "interfaces/msg/detail/telemetry__rosidl_typesupport_fastrtps_c.h"
...
using _Telemetry__ros_msg_type = interfaces__msg__Telemetry;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: battery_mah_used
  {
    cdr << ros_message->battery_mah_used;
  }
...
size_t get_serialized_size_interfaces__msg__Telemetry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name battery_mah_used
  {
    size_t item_size = sizeof(ros_message->battery_mah_used);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name rssi
...
static uint32_t _Telemetry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Telemetry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Telemetry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__Telemetry;
    is_plain =
      (
...
static size_t _Telemetry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Telemetry(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Telemetry)() {
