...
bool interfaces__msg__motion_capture_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._motion_capture_state.MotionCaptureState", full_classname_dest, 55) == 0);
  }
  interfaces__msg__MotionCaptureState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of MotionCaptureState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._motion_capture_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotionCaptureState");
