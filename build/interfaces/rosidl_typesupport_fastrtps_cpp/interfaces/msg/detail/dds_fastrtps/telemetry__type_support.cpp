...
#include "interfaces/msg/detail/telemetry__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Telemetry & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Telemetry & ros_message)
{
  // Member: battery_voltage
  cdr >> ros_message.battery_voltage;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Telemetry;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Telemetry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Telemetry *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Telemetry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Telemetry)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Telemetry__handle;
}
